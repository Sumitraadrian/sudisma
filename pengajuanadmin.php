...
$query = "SELECT p.*, j.nama_jurusan 
          ...
          WHERE p.status = 'pending' AND (p.status_wadek IS NULL OR p.status_wadek = 'pending')
                        ...
                        <?php foreach ($pengajuans as $row): ?>
                            <tr>
                                ...
                                <td class="action-buttons text-center">
                                    <a href="persetujuanadmin.php?id=<?= urlencode($row['id']); ?>" class="btn btn-info btn-custom" style="text-decoration: none;">
