...
<div class="main-content" id="content">
    <div class="container mt-5">
        <div class="table-container">
            <div class="header-title">List Data Dispensasi Ditolak oleh Wakil Dekan</div>
            ...
            <?php else: ?>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="9" class="text-center">Belum ada data dispensasi yang ditolak oleh Wakil Dekan</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
